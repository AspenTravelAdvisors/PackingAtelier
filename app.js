...
const wardrobeCategories = [
  {
    key: "shirts",
    label: "Shirts",
    items: ["white linen shirt", "light blue linen shirt", "navy polo", "ivory tee", "blue print shirt"]
  },
  {
    key: "layers",
    label: "Jackets & Layers",
    items: ["tan sport coat", "tobacco overshirt", "cream knit", "navy travel jacket", "light rain shell"]
  },
  {
    key: "trousers",
    label: "Trousers",
    items: ["navy trousers", "cream trousers", "stone chinos", "travel pants", "blue linen pants"]
  },
  {
    key: "shorts",
    label: "Shorts",
    items: ["stone shorts", "navy swim shorts", "linen drawstring shorts"]
  },
  {
    key: "shoes",
    label: "Shoes",
    items: ["clean white trainers", "brown loafers", "sandals", "walking shoes"]
  },
  {
    key: "accessories",
    label: "Accessories",
    items: ["belt", "sunglasses", "hat", "watch", "laundry kit", "pocket square"]
  }
];
